...
export default function Layout() {
  const setActive = ({ isActive }) =>
    isActive
      ...
      : "block text-gray-500 ease-out decoration-gray-400 sm:hidden";
  return (
    <div className="min-h-screen bg-gray-700">
      <header className="flex justify-between bg-[#7395AE] py-[3vh] px-[1vh] text-3xl sm:px-[10vh] sm:text-3xl">
        <Link
          to={"/"}
