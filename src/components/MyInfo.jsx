  ...
  return (
    <div className="flex flex-col justify-center sm:flex-row sm:justify-start sm:ml-[10vh] mt-[3vh] sm:mt-[5vh]">
      <img
        src="/itsme.jpg"
        alt="img"
        className="ml-[1vh] w-[40vh] h-[40vh] sm:w-[35vh] sm:h-[35vh] sm:ml-0"
      />
      <p className="ml-[1vh] sm:ml-[2vh] max-w-[90%] sm:max-w-[80%] md:max-w-[35%] text-white text-2xl sm:h-[35vh]">
        ...
        in person by clicking on button "MyProjects"
      </p>
