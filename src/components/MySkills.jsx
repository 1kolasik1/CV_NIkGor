    ...
    <div className="ml-[1vh] sm:ml-0 mt-[5vh] min-w-[240px]">
      <div>
        <div className="flex flex-col">
          ...
          <div className="text-gray-400 text-2xl mb-[1vh]">Russian: native</div>
          <div className="text-gray-400 text-2xl mb-[1vh]">English: B1-B2</div>
        </div>
      </div>
      <div className="mt-[5vh]">
        <p className="text-white text-3xl mb-[1vh] font-semibold">My skills:</p>
        <div className="flex flex-col">
          <div className="flex items-center text-gray-400 text-2xl mb-[1vh]">
            <p>React</p>
